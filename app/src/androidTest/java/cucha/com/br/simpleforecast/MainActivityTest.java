...
public class MainActivityTest {
    ...
    public static void setUp() throws IOException {
        ...
        AppModule.setBaseUrl(mockWebServer.url("/").toString());
        OkHttpClient client = AppModule.getOkHttpClient();
    ...
    @Test
    public void when_start_should_showItens() {
        mockWebServer.enqueue(mockResponseSuccess());

        onView(allOf(withId(R.id.recyclerView), hasDescendant(withId(R.id.textViewForecast))))
                .check(matches(isDisplayed()));
    }

    @Test
    public void when_userNotIsPremium_shouldNot_showFeatureButton() {
        mockWebServer.enqueue(mockResponseSuccess());
    ...
    @Test
    public void when_startAndFail_should_showFailMessage() throws InterruptedException {
        mockWebServer.enqueue(mockResponseFail());

        onView(withText(R.string.servico_indisponivel)).check(matches(isDisplayed()));
    }

    private MockResponse mockResponseSuccess() {
    ...
    private MockResponse mockResponseFail() {
        MockResponse response = new MockResponse();
